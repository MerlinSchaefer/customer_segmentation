...
# MAGIC %md
# MAGIC # Preprocessing Pipeline EXPLORATION
# MAGIC
# MAGIC This notebook can be used to explore and experiment with different pipeline options.
# MAGIC To change the pipelines used in the delta live tables run the job `update_preprocessing_pipelines`
...
pipeline_model_no_scaling.write().overwrite().save("dbfs:/FileStore/customer_segmentation/pipelines/preprocessing/experimental/no_scaling")

# COMMAND ----------

pipeline_model_scaling.write().overwrite().save("dbfs:/FileStore/customer_segmentation/pipelines/preprocessing/experimental/scaling")
